...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    feature_2=req.params.get('Comp discharge pressure')
    feature_3=req.params.get('Comp IGV angle')


    parameters=[feature_1,feature_2,feature_3]
    
    if all( isANumber(i) for i in parameters):
        generated_watts=calculate_generated_power([feature_1,feature_2,feature_3])
